...
const handleLogin = async () => {
    ...
    try {
        ...
        if (rawRedirect) {
            ...
            // Validasi: hanya izinkan path yang dimulai dengan '/'
                    ...
                    <div class="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white py-16 px-10 text-center sm:px-12 md:px-[60px] dark:bg-dark-2">
                        ...
                        <form @submit.prevent="handleLogin">
                            ...
                            <div class="mb-6 flex items-center space-x-2">
                                ...
                                <Label for="remember" class="text-gray-600 font-medium">Ingat saya</Label>
                            </div>
                        ...
                        <!-- <p class="mb-6 text-base text-secondary-color dark:text-dark-7">Login dengan</p> -->
                        ...
                        <NuxtLink to="#" class="inline-block mb-2 text-base text-dark dark:text-white hover:text-primary hover:underline">
                            Lupa password?
                        </NuxtLink>
                        <p class="text-base text-body-color dark:text-dark-6">
                            <span class="pr-0.5">Belum menjadi anggota?</span>
                            <NuxtLink to="/auth/register" class="text-primary hover:underline"> Daftar </NuxtLink>
                        </p>
                        <div>
