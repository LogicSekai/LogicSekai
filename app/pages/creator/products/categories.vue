    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-muted-foreground">
          Kelola kategori produk Anda untuk mengorganisir produk
        </p>
      </div>
    ...
    <Card>
      ...
      <CardContent>
        ...
        <div v-else-if="filteredCategories.length === 0" class="text-center p-8 text-muted-foreground">
          ...
          <p class="text-sm mb-4">Mulai dengan membuat kategori produk pertama Anda</p>
          ...
          >
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p class="text-sm text-muted-foreground" v-if="category.description">
            ...
            <div class="flex items-center gap-2">
              ...
              <Button 
                ...
                :title="`${category.isActive ? 'Nonaktifkan' : 'Aktifkan'} kategori`"
              >
