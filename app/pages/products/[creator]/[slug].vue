                ...
                <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    <div class="lg:w-72 xl:w-80 shrink-0 space-y-4">
                        ...
                        <div class="border border-gray-100 dark:border-white/6">
                            ...
                            <div class="p-5 space-y-2">
                                <a href="mailto:samehikari@gmail.com"
                                    ...
                                    <span class="text-xs text-gray-600 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white transition-colors truncate">samehikari@gmail.com</span>
                                </a>
                                <a href="https://wa.me/+1234567890" target="_blank"
                                    ...
                                    <span class="text-xs text-gray-600 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white transition-colors">+1234567890</span>
                                </a>
                                <a href="https://t.me/samehikari" target="_blank"
                                    ...
                                    <span class="text-xs text-gray-600 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white transition-colors">@samehikari</span>
                                </a>
                                <div class="flex items-start gap-2 pt-2 text-xs text-gray-400">
                                    <svg class="w-3.5 h-3.5 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
