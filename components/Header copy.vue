        ...
        <div class="container mx-auto px-4">
            <div class="relative flex items-center justify-between h-16 md:h-20">
                ...
                <nav class="hidden md:flex items-center space-x-1 lg:space-x-6">
                    <NuxtLink to="/" class="px-3 py-2 text-sm font-medium text-dark dark:text-white hover:text-primary transition-colors">
                        Beranda
                    </NuxtLink>
                    <NuxtLink to="/products" class="px-3 py-2 text-sm font-medium text-dark dark:text-white hover:text-primary transition-colors">
                        Layanan Produk
                    </NuxtLink>
                    <NuxtLink to="#" class="px-3 py-2 text-sm font-medium text-dark dark:text-white hover:text-primary transition-colors">
                        Artikel
                ...
                <div class="hidden md:flex items-center space-x-2 ml-4">
                    <template v-if="authStore.isAuthenticated">
                        ...
                        <button class="flex items-center space-x-2 focus:outline-none">
                            ...
                            >
                            <span class="hidden lg:inline text-sm font-medium text-dark dark:text-white">
                            {{ authStore.user.name }}
                            </span>
                    ...
                    <template v-else>
                        <NuxtLink 
                        to="/auth" 
                        class="px-4 py-2 text-sm font-medium text-dark dark:text-white hover:text-primary"
                        >
                        Masuk
                        </NuxtLink>
                        <NuxtLink 
                        to="#" 
                        class="px-4 py-2 text-sm font-medium text-white bg-primary rounded-md hover:bg-opacity-90"
                        >
                        Daftar
                        </NuxtLink>
                    </template>
